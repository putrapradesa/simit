<section class="content">
    <div class="row clearfix ">
        ...
        <div class="col-lg-12 col-md-11 col-sm-11 col-xs-12">
            <div class = "card col-lg-12 col-md-11 col-sm-11 col-xs-12 align-self-center">
                ...
                <div class = "header">
                    <button type="button" class="btn bg-blue waves-effect " data-toggle="modal" data-target="#tambah-kategori"><i class="material-icons">add_box</i> <span>Tambah</span></button>
                    <!-- <a href="<?php echo base_url();?>master/kategori/Excel" class = "btn bg-blue waves-effect" ><i class="material-icons">file_download</i><span>Excel</span></a> -->
                    <!-- <a href="<?php echo base_url();?>master/kategori/PDF" class = "btn bg-blue waves-effect" ><i class="material-icons">file_download</i><span>PDF</span></a> -->
    ...
    function tampilKategori() {
        $.get('<?php echo base_url('master/kategori/tampil'); ?>', function(data) {
            MyTable.fnDestroy();
    ...
    $('#form-tambah-kategori').submit(function(e) {
        ...
        $.ajax({
            method: 'POST',
            url: '<?php echo base_url('master/kategori/add'); ?>',
            data: data
        })
        .done(function(data) {
    ...
    $(document).on("click", ".hapus-datakategori", function() {
        ...
        $.ajax({
            method: "POST",
            url: "<?php echo base_url('master/kategori/delete'); ?>",
            data: "id=" +id
        })
        .done(function(data) {
    ...
    $(document).on('submit', '#form-update-kategori', function(e){
        ...
        $.ajax({
            method: 'POST',
            url: '<?php echo base_url('master/kategori/edit'); ?>',
            data: data
        })
        .done(function(data) {
            var out = jQuery.parseJSON(data);
